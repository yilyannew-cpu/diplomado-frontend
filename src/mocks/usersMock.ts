...
export const usersMock: MockUser[] = [
  ...
  { id: "USR-06", name: "Seba Courier", email: "domi2@ffcore.co", password: "demo", role: "domiciliario", phone: "+57 316 555 0655", vehicle: "Bici eléctrica — BIC-09", status: "Activo", avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=200&h=200&q=80", document_id: "1020456789", vehicle_type: "Bicicleta", vehicle_description: "Bici eléctrica GW negra", emergency_contact_name: "María Pérez", emergency_contact_phone: "+57 311 333 4455", is_available: false },
  { id: "USR-06B", name: "Camilo Repartidor", email: "domi3@ffcore.co", password: "demo", role: "domiciliario", phone: "+57 318 555 0999", vehicle: "Moto Yamaha — XYZ-123", status: "Activo", avatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=200&h=200&q=80", document_id: "1055555555", vehicle_type: "Motocicleta", vehicle_plate: "XYZ-123", vehicle_description: "Yamaha FZ negra", emergency_contact_name: "Luisa Fernández", emergency_contact_phone: "+57 312 444 5566", is_available: false },
