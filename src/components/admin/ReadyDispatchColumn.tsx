  ...
  return (
    <div className="space-y-4">
      {zoneGroups.map(({ zone, orders: zoneOrders }) => (
        <div
          key={zone}
          className="rounded-2xl border border-emerald-500/20 bg-emerald-500/[0.03] p-3 shadow-sm transition-all duration-300"
        >
    ...
    <div className="space-y-2">
      ...
      {readyToDispatch ? (
        <button
          type="button"
          onClick={onDispatch}
          className="flex w-full items-center justify-center gap-2 rounded-lg bg-emerald-600 px-3 py-2 text-[11px] font-semibold text-white transition-all duration-300 hover:bg-emerald-700"
        >
        ...
        <button
          type="button"
          onClick={onAssign}
          className="w-full rounded-lg bg-ink px-3 py-2 text-[11px] font-semibold text-cream transition-all duration-300 hover:bg-primary"
        >
