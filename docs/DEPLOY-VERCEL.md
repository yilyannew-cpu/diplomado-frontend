# Guía completa de despliegue en Vercel — BurgerCore / diplomado-frontend
...
*Última actualización: configuración aplicada en `vite.config.ts` y `vercel.json` del repositorio diplomado-frontend (BurgerCore).*
